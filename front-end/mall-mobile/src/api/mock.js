...
Mock.mock("http://localhost:8088/category/info",categoryinfo);
...
Mock.mock("http://localhost:8088/cart/index",cart);


Mock.mock("http://localhost:8088/login",{"errno":0,"token":"bbbbbbbbbbbbb"});